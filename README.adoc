...
The endpoint that will receive the generated payloads. Fake-O-Matic will use the POST verb for calling it.
...
Defines where to locate the template for generating the payloads.
