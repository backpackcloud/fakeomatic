...
`url` to define the API endpoint and an optional https://tools.ietf.org/html/rfc6901[JSON Pointer] param `return`
to specify which part of the API response represents the data (uses the whole response if not supplied).
